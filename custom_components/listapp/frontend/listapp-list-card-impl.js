...
\f\r"'\`<>=]|("|')|))|$)`,"g"),Gt=/'/g,Kt=/"/g,Zt=/^(?:script|style|textarea|title)$/i,Tt=s=>(e,...t)=>({_$litType$:s,strings:e,values:t}),p=Tt(1),Jt=Tt(2),Li=Tt(3),b=Symbol.for("lit-noChange"),h=Symbol.for("lit-nothing"),Wt=new WeakMap,H=D.createTreeWalker(D,129);function Qt(s,e){if(!Et(s)||!s.hasOwnProperty("raw"))throw Error("invalid template strings array");return Ft!==void 0?Ft.createHTML(e):e}var Xt=(s,e)=>{let t=s.length-1,i=[],r,n=e===2?"<svg>":e===3?"<math>":"",o=J;for(let a=0;a<t;a++){let l=s[a],u,f,c=-1,g=0;for(;g<l.length&&(o.lastIndex=g,f=o.exec(l),f!==null);)g=o.lastIndex,o===J?f[1]==="!--"?o=jt:f[1]!==void 0?o=qt:f[2]!==void 0?(Zt.test(f[2])&&(r=RegExp("</"+f[2],"g")),o=P):f[3]!==void 0&&(o=P):o===P?f[0]===">"?(o=r??J,c=-1):f[1]===void 0?c=-2:(c=o.lastIndex-f[2].length,u=f[1],o=f[3]===void 0?P:f[3]==='"'?Kt:Gt):o===Kt||o===Gt?o=P:o===jt||o===qt?o=J:(o=P,r=void 0);let m=o===P&&s[a+1].startsWith("/>")?" ":"";n+=o===J?l+Ze:c>=0?(i.push(u),l.slice(0,c)+wt+l.slice(c)+S+m):l+S+(c===-2?a:m)}return[Qt(s,n+(s[t]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),i]},tt=class s{constructor({strings:e,_$litType$:t},i){let r;this.parts=[];let n=0,o=0,a=e.length-1,l=this.parts,[u,f]=Xt(e,t);if(this.el=s.createElement(u,i),H.currentNode=this.el.content,t===2||t===3){let c=this.el.content.firstChild;c.replaceWith(...c.childNodes)}for(;(r=H.nextNode())!==null&&l.length<a;){if(r.nodeType===1){if(r.hasAttributes())for(let c of r.getAttributeNames())if(c.endsWith(wt)){let g=f[o++],m=r.getAttribute(c).split(S),_=/([.?@])?(.*)/.exec(g);l.push({type:1,index:n,name:_[2],strings:m,ctor:_[1]==="."?ct:_[1]==="?"?ht:_[1]==="@"?pt:L}),r.removeAttribute(c)}else c.startsWith(S)&&(l.push({type:6,index:n}),r.removeAttribute(c));if(Zt.test(r.tagName)){let c=r.textContent.split(S),g=c.length-1;if(g>0){r.textContent=lt?lt.emptyScript:"";for(let m=0;m<g;m++)r.append(c[m],Q()),H.nextNode(),l.push({type:2,index:++n});r.append(c[g],Q())}}}else if(r.nodeType===8)if(r.data===At)l.push({type:2,index:n});else{let c=-1;for(;(c=r.data.indexOf(S,c+1))!==-1;)l.push({type:7,index:n}),c+=S.length-1}n++}}static createElement(e,t){let i=D.createElement("template");return i.innerHTML=e,i}};function U(s,e,t=s,i){if(e===b)return e;let r=i!==void 0?t._$Co?.[i]:t._$Cl,n=X(e)?void 0:e._$litDirective$;return r?.constructor!==n&&(r?._$AO?.(!1),n===void 0?r=void 0:(r=new n(s),r._$AT(s,t,i)),i!==void 0?(t._$Co??=[])[i]=r:t._$Cl=r),r!==void 0&&(e=U(s,r._$AS(s,e.values),r,i)),e}var dt=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){let{el:{content:t},parts:i}=this._$AD,r=(e?.creationScope??D).importNode(t,!0);H.currentNode=r;let n=H.nextNode(),o=0,a=0,l=i[0];for(;l!==void 0;){if(o===l.index){let u;l.type===2?u=new z(n,n.nextSibling,this,e):l.type===1?u=new l.ctor(n,l.name,l.strings,this,e):l.type===6&&(u=new ut(n,this,e)),this._$AV.push(u),l=i[++a]}o!==l?.index&&(n=H.nextNode(),o++)}return H.currentNode=D,r}p(e){let t=0;for(let i of this._$AV)i!==void 0&&(i.strings!==void 0?(i._$AI(e,i,t),t+=i.strings.length-2):i._$AI(e[t])),t++}},z=class s{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,i,r){this.type=2,this._$AH=h,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=i,this.options=r,this._$Cv=r?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode,t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=U(this,e,t),X(e)?e===h||e==null||e===""?(this._$AH!==h&&this._$AR(),this._$AH=h):e!==this._$AH&&e!==b&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):Yt(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==h&&X(this._$AH)?this._$AA.nextSibling.data=e:this.T(D.createTextNode(e)),this._$AH=e}$(e){let{values:t,_$litType$:i}=e,r=typeof i=="number"?this._$AC(e):(i.el===void 0&&(i.el=tt.createElement(Qt(i.h,i.h[0]),this.options)),i);if(this._$AH?._$AD===r)this._$AH.p(t);else{let n=new dt(r,this),o=n.u(this.options);n.p(t),this.T(o),this._$AH=n}}_$AC(e){let t=Wt.get(e.strings);return t===void 0&&Wt.set(e.strings,t=new tt(e)),t}k(e){Et(this._$AH)||(this._$AH=[],this._$AR());let t=this._$AH,i,r=0;for(let n of e)r===t.length?t.push(i=new s(this.O(Q()),this.O(Q()),this,this.options)):i=t[r],i._$AI(n),r++;r<t.length&&(this._$AR(i&&i._$AB.nextSibling,r),t.length=r)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e!==this._$AB;){let i=Bt(e).nextSibling;Bt(e).remove(),e=i}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}},L=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,i,r,n){this.type=1,this._$AH=h,this._$AN=void 0,this.element=e,this.name=t,this._$AM=r,this.options=n,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=h}_$AI(e,t=this,i,r){let n=this.strings,o=!1;if(n===void 0)e=U(this,e,t,0),o=!X(e)||e!==this._$AH&&e!==b,o&&(this._$AH=e);else{let a=e,l,u;for(e=n[0],l=0;l<n.length-1;l++)u=U(this,a[i+l],t,l),u===b&&(u=this._$AH[l]),o||=!X(u)||u!==this._$AH[l],u===h?e=h:e!==h&&(e+=(u??"")+n[l+1]),this._$AH[l]=u}o&&!r&&this.j(e)}j(e){e===h?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}},ct=class extends L{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===h?void 0:e}},ht=class extends L{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==h)}},pt=class extends L{constructor(e,t,i,r,n){super(e,t,i,r,n),this.type=5}_$AI(e,t=this){if((e=U(this,e,t,0)??h)===b)return;let i=this._$AH,r=e===h&&i!==h||e.capture!==i.capture||e.once!==i.once||e.passive!==i.passive,n=e!==h&&(i===h||r);r&&this.element.removeEventListener(this.name,this,i),n&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}},ut=class{constructor(e,t,i){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(e){U(this,e)}},te={M:wt,P:S,A:At,C:1,L:Xt,R:dt,D:Yt,V:U,I:z,H:L,N:ht,U:pt,B:ct,F:ut},Je=$t.litHtmlPolyfillSupport;Je?.(tt,z),($t.litHtmlVersions??=[]).push("3.3.3");var ee=(s,e,t)=>{let i=t?.renderBefore??e,r=i._$litPart$;if(r===void 0){let n=t?.renderBefore??null;i._$litPart$=r=new z(e.insertBefore(Q(),n),n,void 0,t??{})}return r._$AI(s),r};var Ct=globalThis,E=class extends k{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=ee(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return b}};E._$litElement$=!0,E.finalized=!0,Ct.litElementHydrateSupport?.({LitElement:E});var Qe=Ct.litElementPolyfillSupport;Qe?.({LitElement:E});(Ct.litElementVersions??=[]).push("4.2.2");var Xe={attribute:!0,type:String,converter:Z,reflect:!1,hasChanged:at},ti=(s=Xe,e,t)=>{let{kind:i,metadata:r}=t,n=globalThis.litPropertyMetadata.get(r);if(n===void 0&&globalThis.litPropertyMetadata.set(r,n=new Map),i==="setter"&&((s=Object.create(s)).wrapped=!0),n.set(t.name,s),i==="accessor"){let{name:o}=t;return{set(a){let l=e.get.call(this);e.set.call(this,a),this.requestUpdate(o,l,s,!0,a)},init(a){return a!==void 0&&this.C(o,void 0,s,a),a}}}if(i==="setter"){let{name:o}=t;return function(a){let l=this[o];e.call(this,a),this.requestUpdate(o,l,s,!0,a)}}throw Error("Unsupported decorator location: "+i)};function B(s){return(e,t)=>typeof t=="object"?ti(s,e,t):((i,r,n)=>{let o=r.hasOwnProperty(n);return r.constructor.createProperty(n,i),o?Object.getOwnPropertyDescriptor(r,n):void 0})(s,e,t)}function y(s){return B({...s,state:!0,attribute:!1})}var I={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},C=s=>(...e)=>({_$litDirective$:s,values:e}),T=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,i){this._$Ct=e,this._$AM=t,this._$Ci=i}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}};var et=C(class extends T{constructor(s){if(super(s),s.type!==I.ATTRIBUTE||s.name!=="class"||s.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(s){return" "+Object.keys(s).filter(e=>s[e]).join(" ")+" "}update(s,[e]){if(this.st===void 0){this.st=new Set,s.strings!==void 0&&(this.nt=new Set(s.strings.join(" ").split(/\s/).filter(i=>i!=="")));for(let i in e)e[i]&&!this.nt?.has(i)&&this.st.add(i);return this.render(e)}let t=s.element.classList;for(let i of this.st)i in e||(t.remove(i),this.st.delete(i));for(let i in e){let r=!!e[i];r===this.st.has(i)||this.nt?.has(i)||(r?(t.add(i),this.st.add(i)):(t.remove(i),this.st.delete(i)))}return b}});var{I:ei}=te,ie=s=>s;var se=()=>document.createComment(""),F=(s,e,t)=>{let i=s._$AA.parentNode,r=e===void 0?s._$AB:e._$AA;if(t===void 0){let n=i.insertBefore(se(),r),o=i.insertBefore(se(),r);t=new ei(n,o,s,s.options)}else{let n=t._$AB.nextSibling,o=t._$AM,a=o!==s;if(a){let l;t._$AQ?.(s),t._$AM=s,t._$AP!==void 0&&(l=s._$AU)!==o._$AU&&t._$AP(l)}if(n!==r||a){let l=t._$AA;for(;l!==n;){let u=ie(l).nextSibling;ie(i).insertBefore(l,r),l=u}}}return t},R=(s,e,t=s)=>(s._$AI(e,t),s),ii={},re=(s,e=ii)=>s._$AH=e,ne=s=>s._$AH,gt=s=>{s._$AR(),s._$AA.remove()};var oe=(s,e,t)=>{let i=new Map;for(let r=e;r<=t;r++)i.set(s[r],r);return i},ae=C(class extends T{constructor(s){if(super(s),s.type!==I.CHILD)throw Error("repeat() can only be used in text expressions")}dt(s,e,t){let i;t===void 0?t=e:e!==void 0&&(i=e);let r=[],n=[],o=0;for(let a of s)r[o]=i?i(a,o):o,n[o]=t(a,o),o++;return{values:n,keys:r}}render(s,e,t){return this.dt(s,e,t).values}update(s,[e,t,i]){let r=ne(s),{values:n,keys:o}=this.dt(e,t,i);if(!Array.isArray(r))return this.ut=o,n;let a=this.ut??=[],l=[],u,f,c=0,g=r.length-1,m=0,_=n.length-1;for(;c<=g&&m<=_;)if(r[c]===null)c++;else if(r[g]===null)g--;else if(a[c]===o[m])l[m]=R(r[c],n[m]),c++,m++;else if(a[g]===o[_])l[_]=R(r[g],n[_]),g--,_--;else if(a[c]===o[_])l[_]=R(r[c],n[_]),F(s,l[_+1],r[c]),c++,_--;else if(a[g]===o[m])l[m]=R(r[g],n[m]),F(s,r[c],r[g]),g--,m++;else if(u===void 0&&(u=oe(o,m,_),f=oe(a,c,g)),u.has(a[c]))if(u.has(a[g])){let A=f.get(o[m]),w=A!==void 0?r[A]:null;if(w===null){let Ut=F(s,r[c]);R(Ut,n[m]),l[m]=Ut}else l[m]=R(w,n[m]),F(s,r[c],w),r[A]=null;m++}else gt(r[g]),g--;else gt(r[c]),c++;for(;m<=_;){let A=F(s,l[_+1]);R(A,n[m]),l[m++]=A}for(;c<=g;){let A=r[c++];A!==null&&gt(A)}return this.ut=o,re(s,l),b}});var le="important",si=" !"+le,Mt=C(class extends T{constructor(s){if(super(s),s.type!==I.ATTRIBUTE||s.name!=="style"||s.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(s){return Object.keys(s).reduce((e,t)=>{let i=s[t];return i==null?e:e+`${t=t.includes("-")?t:t.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${i};`},"")}update(s,[e]){let{style:t}=s.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(e)),this.render(e);for(let i of this.ft)e[i]==null&&(this.ft.delete(i),i.includes("-")?t.removeProperty(i):t[i]=null);for(let i in e){let r=e[i];if(r!=null){this.ft.add(i);let n=typeof r=="string"&&r.endsWith(si);i.includes("-")||n?t.setProperty(i,n?r.slice(0,-11):r,n?le:""):t[i]=r}}return b}});var de=["#f59e0b","#14b8a6","#6366f1","#ec4899","#0ea5e9","#22c55e"];function ri(s){let e=0;for(let t=0;t<s.length;t++)e=e*31+s.charCodeAt(t)|0;return de[Math.abs(e)%de.length]}var kt="#03a9f4",ni="#ffffff",oi=/^#?([0-9a-f]{3}|[0-9a-f]{6})$/i;function ft(s){let e=oi.exec(s.trim());if(!e)return null;let t=e[1];t.length===3&&(t=t.split("").map(r=>r+r).join(""));let i=parseInt(t,16);return[i>>16&255,i>>8&255,i&255]}function ce(s){let e=ft(s);if(e)return e;let t=/^rgba?\(\s*([\d.]+)[\s,]+([\d.]+)[\s,]+([\d.]+)/i.exec(s.trim());return t?[Number(t[1]),Number(t[2]),Number(t[3])].map(i=>Math.max(0,Math.min(255,Math.round(i)))):null}function _t([s,e,t]){return"#"+[s,e,t].map(i=>i.toString(16).padStart(2,"0")).join("")}function he([s,e,t]){let i=r=>{let n=r/255;return n<=.03928?n/12.92:((n+.055)/1.055)**2.4};return .2126*i(s)+.7152*i(e)+.0722*i(t)}function ai(s,e){let t=he(s),i=he(e);return(Math.max(t,i)+.05)/(Math.min(t,i)+.05)}function pe(s,e,t){return s.map((i,r)=>Math.round(i+(e[r]-i)*t))}var li=(s,e)=>pe(s,[255,255,255],e),di=(s,e)=>pe(s,[0,0,0],e);function ue(s,e){return typeof s=="string"&&ft(s)?_t(ft(s)):ri(e??"")}var ci={dark:{field:"rgba(0, 0, 0, 0.3)",hover:"rgba(255, 255, 255, 0.05)",track:"rgba(255, 255, 255, 0.14)"},light:{field:"rgba(0, 0, 0, 0.06)",hover:"rgba(0, 0, 0, 0.04)",track:"rgba(0, 0, 0, 0.1)"}},hi=4.5,pi=.38;function ui(s,e,t){if(t)return _t(li(s,pi));let i=s;for(;ai(i,e)<hi&&i.some(r=>r>0);){let r=di(i,.12);i=r.every((n,o)=>n===i[o])?[0,0,0]:r}return _t(i)}function me(s,e,t){let i=ce(s)??ft(kt),r=ce(e)??(t?[28,28,28]:[255,255,255]);return{accent:_t(i),glyph:ni,ink:ui(i,r,t),...ci[t?"dark":"light"]}}var mi="listapp-list-card",it=(s,e)=>typeof s=="boolean"?s:e;function ge(s){if(!s||typeof s!="object")throw new Error("Invalid configuration");if("show_title"in s)throw new Error("show_title was renamed to show_header");if(typeof s.entity!="string"||!/^todo\.[a-z0-9_]+$/.test(s.entity))throw new Error("Specify an entity from within the todo domain");if(s.item_tap_action!==void 0&&s.item_tap_action!=="toggle"&&s.item_tap_action!=="edit")throw new Error("item_tap_action must be 'toggle' or 'edit'");let e=s.collapse_to??0;if(typeof e!="number"||!Number.isInteger(e)||e<0)throw new Error("collapse_to must be a non-negative integer");return{entity:s.entity,title:typeof s.title=="string"&&s.title.trim()?s.title:void 0,useListColor:it(s.use_list_color,!0),showHeader:it(s.show_header,!0),showAdd:it(s.show_add,!0),showCompleted:it(s.show_completed,!0),showProgress:it(s.show_progress,!0),collapseTo:e,itemTapAction:s.item_tap_action??"toggle"}}function fe(s,e){let t=s.find(i=>i.startsWith("todo.")&&typeof e[i]?.attributes.list_id=="string")??s.find(i=>i.startsWith("todo."))??"";return{type:`custom:${mi}`,entity:t}}var N={CREATE:1,DELETE:2,UPDATE:4,MOVE:8},_e="unavailable",ve="unknown",O=(s,e)=>((s?.attributes.supported_features??0)&e)!==0,be=(s,e,t)=>s.connection.subscribeMessage(t,{type:"todo/item/subscribe",entity_id:e}),ye=(s,e,t)=>s.callService("todo","add_item",{item:t},{entity_id:e}),St=(s,e,t,i)=>s.callService("todo","update_item",{item:t.uid,status:i},{entity_id:e}),xe=(s,e,t,i)=>s.callService("todo","update_item",{item:t.uid,rename:i,status:t.status??"needs_action"},{entity_id:e}),It=(s,e,t)=>s.callService("todo","remove_item",{item:t},{entity_id:e}),$e=(s,e,t,i)=>s.callWS({type:"todo/item/move",entity_id:e,uid:t,previous_uid:i}),we=(s,e)=>s.callWS({type:"config/entity_registry/get",entity_id:e}),Ae=(s,e)=>s.callWS({type:"config_entries/get",domain:e}),Ee=s=>s.callWS({type:"config_entries/flow/progress"}),Te="/config/integrations/integration/listapp";function Ce(s){history.pushState(null,"",s),window.dispatchEvent(new CustomEvent("location-changed",{bubbles:!0,composed:!0,detail:{replace:!1}}))}function fi(s){let e=[],t=[];for(let i of s)(i.status==="completed"?t:e).push(i);return{active:e,completed:t}}function Rt(s){return s?s.attributes.role==="viewer"?!0:!O(s,N.CREATE)||!O(s,N.UPDATE):!1}function _i(s,e,t){return t||e<=0||s.length<=e?{shown:s,hidden:0}:{shown:s.slice(0,e),hidden:s.length-e}}function vi(s,e,t){return t?`${s} ${s===1?"item":"items"} \xB7 view only`:s===0?"No items":`${e} of ${s} done`}function bi(s,e){let t=s?.attributes.friendly_name;return typeof t=="string"&&t.trim()?t:e.split(".")[1]?.replace(/^listapp_/,"").replace(/_/g," ")??e}var Pt=s=>s.state===_e||s.state===ve;function Ht(s,e,t,i=void 0,r="listapp"){return!s||!Pt(s)?"available":t?.some(a=>a.handler===r&&a.context?.source==="reauth"&&(!i||a.context.entry_id===i))||e?.some(a=>a.domain===r&&(!i||a.entry_id===i)&&a.state==="setup_error"&&/auth|token|sign in|log in|credential/i.test(a.reason??""))?"auth":"transient"}function Me({config:s,stateObj:e,items:t,availability:i,expanded:r}){let n=Rt(e),o=!n&&O(e,N.CREATE),a=!n&&O(e,N.UPDATE),l=!n&&O(e,N.DELETE),u=!n&&O(e,N.MOVE),{active:f,completed:c}=fi(t??[]),g=f.length+c.length,m=c.length,{shown:_,hidden:A}=_i(f,s.collapseTo,r),w;return e?i==="auth"?w="unavailable_auth":i==="transient"?w="unavailable_transient":t===void 0?w="loading":g===0?w="empty":f.length===0?w="all_done":w="list":w="missing",{state:w,viewer:n,canCreate:o,canUpdate:a,canDelete:l,canMove:u,title:s.title??bi(e,s.entity),subline:vi(g,m,n),total:g,done:m,progress:g===0?0:m/g,active:f,completed:c,visibleActive:_,hiddenActive:A,showHeader:s.showHeader,showAdd:s.showAdd&&o,showCompleted:s.showCompleted,showProgress:s.showProgress&&s.showHeader}}function ke(s,e,t){let i=s.filter(o=>o.uid!==e),r=s.find(o=>o.uid===e);if(!r)return{order:s,previousUid:void 0};let n=Math.max(0,Math.min(t,i.length));return i.splice(n,0,r),{order:i,previousUid:n===0?void 0:i[n-1].uid}}var Se="listapp-list-card-impl",Dt="listapp-list-card-editor",Ie="listapp-list-card-editor-impl";var Re=[0,100,500],yi='listapp-list-card: customElements.define did not take. Something on this page is wrapping the custom element registry \u2014 a scoped custom element registry polyfill, or another frontend integration patching customElements. Listapp cards will show "Configuration error" until the page is reloaded; see https://github.com/garrett-livefront/listapp-ha/blob/main/docs/card.md#registry-patching';var Pe=!1;function xi(){Pe||(Pe=!0,console.warn(yi))}function $i(s,e,t){if(s.get(e))return!0;try{s.define(e,t)}catch{}return s.get(e)!==void 0}function j(s,e,t={},i=0){if(e.map(([n,o])=>$i(s,n,o)).every(Boolean)){t.onAllResolved?.();return}if(i>Re.length){(t.onExhausted??xi)();return}if(i===0){queueMicrotask(()=>j(s,e,t,1));return}setTimeout(()=>j(s,e,t,i+1),Re[i-1])}var x={use_list_color:!0,show_header:!0,show_add:!0,show_completed:!0,show_progress:!0,collapse_to:0,item_tap_action:"toggle"},De=[{value:"toggle",label:"Toggle"},{value:"edit",label:"Edit"}];function wi(s){let e=Object.keys(s.states).filter(i=>i.startsWith("todo.")),t=e.filter(i=>typeof s.states[i]?.attributes.list_id=="string");return t.length?t:e}function He(s){return{entity:s.entity??"",title:s.title??"",use_list_color:s.use_list_color??x.use_list_color,show_header:s.show_header??x.show_header,show_add:s.show_add??x.show_add,show_completed:s.show_completed??x.show_completed,show_progress:s.show_progress??x.show_progress,collapse_to:s.collapse_to??x.collapse_to,item_tap_action:s.item_tap_action??x.item_tap_action}}function Ai(s,e){let t={type:e,entity:s.entity},i=typeof s.title=="string"?s.title.trim():"";i&&(t.title=i),s.use_list_color!==x.use_list_color&&(t.use_list_color=s.use_list_color),s.show_header!==x.show_header&&(t.show_header=s.show_header),s.show_add!==x.show_add&&(t.show_add=s.show_add),s.show_completed!==x.show_completed&&(t.show_completed=s.show_completed),s.show_progress!==x.show_progress&&(t.show_progress=s.show_progress);let r=typeof s.collapse_to=="number"&&Number.isInteger(s.collapse_to)&&s.collapse_to>=0?s.collapse_to:x.collapse_to;return r!==x.collapse_to&&(t.collapse_to=r),s.item_tap_action!==x.item_tap_action&&(t.item_tap_action=s.item_tap_action),t}function Ei(s,e){return[{name:"entity",required:!0,selector:{entity:{include_entities:s}}},{name:"title",selector:{text:{}}},{name:"use_list_color",selector:{boolean:{}}},{name:"show_header",selector:{boolean:{}}},{name:"show_add",selector:{boolean:{}}},{name:"show_completed",selector:{boolean:{}}},{name:"show_progress",selector:{boolean:{}},disabled:!e},{name:"collapse_to",selector:{number:{min:0,mode:"box"}}},{name:"item_tap_action",selector:{select:{mode:"dropdown",options:De}}}]}var q={entity:"List",title:"Title override",use_list_color:"Use list colour",show_header:"Show header",show_add:"Show add field",show_completed:"Show completed",show_progress:"Show progress bar",collapse_to:"Collapse to (0 = off)",item_tap_action:"Tap action"},G=class extends E{constructor(){super(...arguments);this._haForm=null;this._haFormChanged=t=>{t.stopPropagation(),this._emit(t.detail.value)};this._nativeChanged=t=>i=>{let r=i.currentTarget,n=He(this._config);r instanceof HTMLInputElement&&r.type==="checkbox"?n[t]=r.checked:r instanceof HTMLInputElement&&r.type==="number"?n[t]=Math.max(0,Math.trunc(Number(r.value)||0)):n[t]=r.value,this._emit(n)}}setConfig(t){this._config=t}connectedCallback(){super.connectedCallback(),this._haForm=customElements.get("ha-form")?!0:null,this._haForm===null&&customElements.whenDefined("ha-form").then(()=>{this._haForm=!0})}_entityIds(){if(!this.hass)return[];let t=wi(this.hass),i=this._config?.entity;return i&&!t.includes(i)?[i,...t]:t}render(){if(!this.hass||!this._config)return h;let t=He(this._config);return p`
    ...
    `}_renderHaForm(t){return p`
      <ha-form
        .hass=${this.hass}
        .data=${t}
        .schema=${Ei(this._entityIds(),t.show_header)}
    ...
    `}_emit(t){let i=Ai(t,this._config.type);this._config=i,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:i},bubbles:!0,composed:!0}))}static{this.styles=W`
    :host {
      display: block;
    }
    .native {
