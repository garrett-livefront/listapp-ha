...
\f\r"'\`<>=]|("|')|))|$)`,"g"),Kt=/'/g,Wt=/"/g,Jt=/^(?:script|style|textarea|title)$/i,Et=s=>(e,...t)=>({_$litType$:s,strings:e,values:t}),p=Et(1),Qt=Et(2),Ri=Et(3),b=Symbol.for("lit-noChange"),h=Symbol.for("lit-nothing"),Yt=new WeakMap,H=D.createTreeWalker(D,129);function Xt(s,e){if(!At(s)||!s.hasOwnProperty("raw"))throw Error("invalid template strings array");return jt!==void 0?jt.createHTML(e):e}var te=(s,e)=>{let t=s.length-1,i=[],n,r=e===2?"<svg>":e===3?"<math>":"",o=Z;for(let a=0;a<t;a++){let l=s[a],u,_,c=-1,g=0;for(;g<l.length&&(o.lastIndex=g,_=o.exec(l),_!==null);)g=o.lastIndex,o===Z?_[1]==="!--"?o=qt:_[1]!==void 0?o=Gt:_[2]!==void 0?(Jt.test(_[2])&&(n=RegExp("</"+_[2],"g")),o=P):_[3]!==void 0&&(o=P):o===P?_[0]===">"?(o=n??Z,c=-1):_[1]===void 0?c=-2:(c=o.lastIndex-_[2].length,u=_[1],o=_[3]===void 0?P:_[3]==='"'?Wt:Kt):o===Wt||o===Kt?o=P:o===qt||o===Gt?o=Z:(o=P,n=void 0);let m=o===P&&s[a+1].startsWith("/>")?" ":"";r+=o===Z?l+Ke:c>=0?(i.push(u),l.slice(0,c)+$t+l.slice(c)+S+m):l+S+(c===-2?a:m)}return[Xt(s,r+(s[t]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),i]},X=class s{constructor({strings:e,_$litType$:t},i){let n;this.parts=[];let r=0,o=0,a=e.length-1,l=this.parts,[u,_]=te(e,t);if(this.el=s.createElement(u,i),H.currentNode=this.el.content,t===2||t===3){let c=this.el.content.firstChild;c.replaceWith(...c.childNodes)}for(;(n=H.nextNode())!==null&&l.length<a;){if(n.nodeType===1){if(n.hasAttributes())for(let c of n.getAttributeNames())if(c.endsWith($t)){let g=_[o++],m=n.getAttribute(c).split(S),f=/([.?@])?(.*)/.exec(g);l.push({type:1,index:r,name:f[2],strings:m,ctor:f[1]==="."?dt:f[1]==="?"?ct:f[1]==="@"?ht:L}),n.removeAttribute(c)}else c.startsWith(S)&&(l.push({type:6,index:r}),n.removeAttribute(c));if(Jt.test(n.tagName)){let c=n.textContent.split(S),g=c.length-1;if(g>0){n.textContent=at?at.emptyScript:"";for(let m=0;m<g;m++)n.append(c[m],J()),H.nextNode(),l.push({type:2,index:++r});n.append(c[g],J())}}}else if(n.nodeType===8)if(n.data===wt)l.push({type:2,index:r});else{let c=-1;for(;(c=n.data.indexOf(S,c+1))!==-1;)l.push({type:7,index:r}),c+=S.length-1}r++}}static createElement(e,t){let i=D.createElement("template");return i.innerHTML=e,i}};function U(s,e,t=s,i){if(e===b)return e;let n=i!==void 0?t._$Co?.[i]:t._$Cl,r=Q(e)?void 0:e._$litDirective$;return n?.constructor!==r&&(n?._$AO?.(!1),r===void 0?n=void 0:(n=new r(s),n._$AT(s,t,i)),i!==void 0?(t._$Co??=[])[i]=n:t._$Cl=n),n!==void 0&&(e=U(s,n._$AS(s,e.values),n,i)),e}var lt=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){let{el:{content:t},parts:i}=this._$AD,n=(e?.creationScope??D).importNode(t,!0);H.currentNode=n;let r=H.nextNode(),o=0,a=0,l=i[0];for(;l!==void 0;){if(o===l.index){let u;l.type===2?u=new z(r,r.nextSibling,this,e):l.type===1?u=new l.ctor(r,l.name,l.strings,this,e):l.type===6&&(u=new pt(r,this,e)),this._$AV.push(u),l=i[++a]}o!==l?.index&&(r=H.nextNode(),o++)}return H.currentNode=D,n}p(e){let t=0;for(let i of this._$AV)i!==void 0&&(i.strings!==void 0?(i._$AI(e,i,t),t+=i.strings.length-2):i._$AI(e[t])),t++}},z=class s{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,i,n){this.type=2,this._$AH=h,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=i,this.options=n,this._$Cv=n?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode,t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=U(this,e,t),Q(e)?e===h||e==null||e===""?(this._$AH!==h&&this._$AR(),this._$AH=h):e!==this._$AH&&e!==b&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):Zt(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==h&&Q(this._$AH)?this._$AA.nextSibling.data=e:this.T(D.createTextNode(e)),this._$AH=e}$(e){let{values:t,_$litType$:i}=e,n=typeof i=="number"?this._$AC(e):(i.el===void 0&&(i.el=X.createElement(Xt(i.h,i.h[0]),this.options)),i);if(this._$AH?._$AD===n)this._$AH.p(t);else{let r=new lt(n,this),o=r.u(this.options);r.p(t),this.T(o),this._$AH=r}}_$AC(e){let t=Yt.get(e.strings);return t===void 0&&Yt.set(e.strings,t=new X(e)),t}k(e){At(this._$AH)||(this._$AH=[],this._$AR());let t=this._$AH,i,n=0;for(let r of e)n===t.length?t.push(i=new s(this.O(J()),this.O(J()),this,this.options)):i=t[n],i._$AI(r),n++;n<t.length&&(this._$AR(i&&i._$AB.nextSibling,n),t.length=n)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e!==this._$AB;){let i=Ft(e).nextSibling;Ft(e).remove(),e=i}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}},L=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,i,n,r){this.type=1,this._$AH=h,this._$AN=void 0,this.element=e,this.name=t,this._$AM=n,this.options=r,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=h}_$AI(e,t=this,i,n){let r=this.strings,o=!1;if(r===void 0)e=U(this,e,t,0),o=!Q(e)||e!==this._$AH&&e!==b,o&&(this._$AH=e);else{let a=e,l,u;for(e=r[0],l=0;l<r.length-1;l++)u=U(this,a[i+l],t,l),u===b&&(u=this._$AH[l]),o||=!Q(u)||u!==this._$AH[l],u===h?e=h:e!==h&&(e+=(u??"")+r[l+1]),this._$AH[l]=u}o&&!n&&this.j(e)}j(e){e===h?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}},dt=class extends L{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===h?void 0:e}},ct=class extends L{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==h)}},ht=class extends L{constructor(e,t,i,n,r){super(e,t,i,n,r),this.type=5}_$AI(e,t=this){if((e=U(this,e,t,0)??h)===b)return;let i=this._$AH,n=e===h&&i!==h||e.capture!==i.capture||e.once!==i.once||e.passive!==i.passive,r=e!==h&&(i===h||n);n&&this.element.removeEventListener(this.name,this,i),r&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}},pt=class{constructor(e,t,i){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(e){U(this,e)}},ee={M:$t,P:S,A:wt,C:1,L:te,R:lt,D:Zt,V:U,I:z,H:L,N:ct,U:ht,B:dt,F:pt},We=xt.litHtmlPolyfillSupport;We?.(X,z),(xt.litHtmlVersions??=[]).push("3.3.3");var ie=(s,e,t)=>{let i=t?.renderBefore??e,n=i._$litPart$;if(n===void 0){let r=t?.renderBefore??null;i._$litPart$=n=new z(e.insertBefore(J(),r),r,void 0,t??{})}return n._$AI(s),n};var Tt=globalThis,E=class extends M{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=ie(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return b}};E._$litElement$=!0,E.finalized=!0,Tt.litElementHydrateSupport?.({LitElement:E});var Ye=Tt.litElementPolyfillSupport;Ye?.({LitElement:E});(Tt.litElementVersions??=[]).push("4.2.2");var Ze={attribute:!0,type:String,converter:Y,reflect:!1,hasChanged:ot},Je=(s=Ze,e,t)=>{let{kind:i,metadata:n}=t,r=globalThis.litPropertyMetadata.get(n);if(r===void 0&&globalThis.litPropertyMetadata.set(n,r=new Map),i==="setter"&&((s=Object.create(s)).wrapped=!0),r.set(t.name,s),i==="accessor"){let{name:o}=t;return{set(a){let l=e.get.call(this);e.set.call(this,a),this.requestUpdate(o,l,s,!0,a)},init(a){return a!==void 0&&this.C(o,void 0,s,a),a}}}if(i==="setter"){let{name:o}=t;return function(a){let l=this[o];e.call(this,a),this.requestUpdate(o,l,s,!0,a)}}throw Error("Unsupported decorator location: "+i)};function B(s){return(e,t)=>typeof t=="object"?Je(s,e,t):((i,n,r)=>{let o=n.hasOwnProperty(r);return n.constructor.createProperty(r,i),o?Object.getOwnPropertyDescriptor(n,r):void 0})(s,e,t)}function y(s){return B({...s,state:!0,attribute:!1})}var I={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},C=s=>(...e)=>({_$litDirective$:s,values:e}),T=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,i){this._$Ct=e,this._$AM=t,this._$Ci=i}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}};var tt=C(class extends T{constructor(s){if(super(s),s.type!==I.ATTRIBUTE||s.name!=="class"||s.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(s){return" "+Object.keys(s).filter(e=>s[e]).join(" ")+" "}update(s,[e]){if(this.st===void 0){this.st=new Set,s.strings!==void 0&&(this.nt=new Set(s.strings.join(" ").split(/\s/).filter(i=>i!=="")));for(let i in e)e[i]&&!this.nt?.has(i)&&this.st.add(i);return this.render(e)}let t=s.element.classList;for(let i of this.st)i in e||(t.remove(i),this.st.delete(i));for(let i in e){let n=!!e[i];n===this.st.has(i)||this.nt?.has(i)||(n?(t.add(i),this.st.add(i)):(t.remove(i),this.st.delete(i)))}return b}});var{I:Qe}=ee,se=s=>s;var ne=()=>document.createComment(""),F=(s,e,t)=>{let i=s._$AA.parentNode,n=e===void 0?s._$AB:e._$AA;if(t===void 0){let r=i.insertBefore(ne(),n),o=i.insertBefore(ne(),n);t=new Qe(r,o,s,s.options)}else{let r=t._$AB.nextSibling,o=t._$AM,a=o!==s;if(a){let l;t._$AQ?.(s),t._$AM=s,t._$AP!==void 0&&(l=s._$AU)!==o._$AU&&t._$AP(l)}if(r!==n||a){let l=t._$AA;for(;l!==r;){let u=se(l).nextSibling;se(i).insertBefore(l,n),l=u}}}return t},R=(s,e,t=s)=>(s._$AI(e,t),s),Xe={},re=(s,e=Xe)=>s._$AH=e,oe=s=>s._$AH,mt=s=>{s._$AR(),s._$AA.remove()};var ae=(s,e,t)=>{let i=new Map;for(let n=e;n<=t;n++)i.set(s[n],n);return i},le=C(class extends T{constructor(s){if(super(s),s.type!==I.CHILD)throw Error("repeat() can only be used in text expressions")}dt(s,e,t){let i;t===void 0?t=e:e!==void 0&&(i=e);let n=[],r=[],o=0;for(let a of s)n[o]=i?i(a,o):o,r[o]=t(a,o),o++;return{values:r,keys:n}}render(s,e,t){return this.dt(s,e,t).values}update(s,[e,t,i]){let n=oe(s),{values:r,keys:o}=this.dt(e,t,i);if(!Array.isArray(n))return this.ut=o,r;let a=this.ut??=[],l=[],u,_,c=0,g=n.length-1,m=0,f=r.length-1;for(;c<=g&&m<=f;)if(n[c]===null)c++;else if(n[g]===null)g--;else if(a[c]===o[m])l[m]=R(n[c],r[m]),c++,m++;else if(a[g]===o[f])l[f]=R(n[g],r[f]),g--,f--;else if(a[c]===o[f])l[f]=R(n[c],r[f]),F(s,l[f+1],n[c]),c++,f--;else if(a[g]===o[m])l[m]=R(n[g],r[m]),F(s,n[c],n[g]),g--,m++;else if(u===void 0&&(u=ae(o,m,f),_=ae(a,c,g)),u.has(a[c]))if(u.has(a[g])){let A=_.get(o[m]),w=A!==void 0?n[A]:null;if(w===null){let Lt=F(s,n[c]);R(Lt,r[m]),l[m]=Lt}else l[m]=R(w,r[m]),F(s,n[c],w),n[A]=null;m++}else mt(n[g]),g--;else mt(n[c]),c++;for(;m<=f;){let A=F(s,l[f+1]);R(A,r[m]),l[m++]=A}for(;c<=g;){let A=n[c++];A!==null&&mt(A)}return this.ut=o,re(s,l),b}});var de="important",ti=" !"+de,Ct=C(class extends T{constructor(s){if(super(s),s.type!==I.ATTRIBUTE||s.name!=="style"||s.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(s){return Object.keys(s).reduce((e,t)=>{let i=s[t];return i==null?e:e+`${t=t.includes("-")?t:t.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${i};`},"")}update(s,[e]){let{style:t}=s.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(e)),this.render(e);for(let i of this.ft)e[i]==null&&(this.ft.delete(i),i.includes("-")?t.removeProperty(i):t[i]=null);for(let i in e){let n=e[i];if(n!=null){this.ft.add(i);let r=typeof n=="string"&&n.endsWith(ti);i.includes("-")||r?t.setProperty(i,r?n.slice(0,-11):n,r?de:""):t[i]=n}}return b}});var ce=["#f59e0b","#14b8a6","#6366f1","#ec4899","#0ea5e9","#22c55e"];function ei(s){let e=0;for(let t=0;t<s.length;t++)e=e*31+s.charCodeAt(t)|0;return ce[Math.abs(e)%ce.length]}var kt="#03a9f4",ii="#ffffff",si=/^#?([0-9a-f]{3}|[0-9a-f]{6})$/i;function gt(s){let e=si.exec(s.trim());if(!e)return null;let t=e[1];t.length===3&&(t=t.split("").map(n=>n+n).join(""));let i=parseInt(t,16);return[i>>16&255,i>>8&255,i&255]}function he(s){let e=gt(s);if(e)return e;let t=/^rgba?\(\s*([\d.]+)[\s,]+([\d.]+)[\s,]+([\d.]+)/i.exec(s.trim());return t?[Number(t[1]),Number(t[2]),Number(t[3])].map(i=>Math.max(0,Math.min(255,Math.round(i)))):null}function _t([s,e,t]){return"#"+[s,e,t].map(i=>i.toString(16).padStart(2,"0")).join("")}function pe([s,e,t]){let i=n=>{let r=n/255;return r<=.03928?r/12.92:((r+.055)/1.055)**2.4};return .2126*i(s)+.7152*i(e)+.0722*i(t)}function ni(s,e){let t=pe(s),i=pe(e);return(Math.max(t,i)+.05)/(Math.min(t,i)+.05)}function ue(s,e,t){return s.map((i,n)=>Math.round(i+(e[n]-i)*t))}var ri=(s,e)=>ue(s,[255,255,255],e),oi=(s,e)=>ue(s,[0,0,0],e);function me(s,e){return typeof s=="string"&&gt(s)?_t(gt(s)):ei(e??"")}var ai={dark:{field:"rgba(0, 0, 0, 0.3)",hover:"rgba(255, 255, 255, 0.05)",track:"rgba(255, 255, 255, 0.14)"},light:{field:"rgba(0, 0, 0, 0.06)",hover:"rgba(0, 0, 0, 0.04)",track:"rgba(0, 0, 0, 0.1)"}},li=4.5,di=.38;function ci(s,e,t){if(t)return _t(ri(s,di));let i=s;for(;ni(i,e)<li&&i.some(n=>n>0);){let n=oi(i,.12);i=n.every((r,o)=>r===i[o])?[0,0,0]:n}return _t(i)}function hi(s,e){let[t,i,n]=s;return`rgba(${t}, ${i}, ${n}, ${e?.18:.1})`}function ge(s,e,t){let i=he(s)??gt(kt),n=he(e)??(t?[28,28,28]:[255,255,255]);return{accent:_t(i),glyph:ii,ink:ci(i,n,t),tint:hi(i,t),...ai[t?"dark":"light"]}}var pi="listapp-list-card",et=(s,e)=>typeof s=="boolean"?s:e;function _e(s){if(!s||typeof s!="object")throw new Error("Invalid configuration");if("show_title"in s)throw new Error("show_title was renamed to show_header");if(typeof s.entity!="string"||!/^todo\.[a-z0-9_]+$/.test(s.entity))throw new Error("Specify an entity from within the todo domain");if(s.item_tap_action!==void 0&&s.item_tap_action!=="toggle"&&s.item_tap_action!=="edit")throw new Error("item_tap_action must be 'toggle' or 'edit'");let e=s.collapse_to??0;if(typeof e!="number"||!Number.isInteger(e)||e<0)throw new Error("collapse_to must be a non-negative integer");return{entity:s.entity,title:typeof s.title=="string"&&s.title.trim()?s.title:void 0,useListColor:et(s.use_list_color,!0),showHeader:et(s.show_header,!0),showAdd:et(s.show_add,!0),showCompleted:et(s.show_completed,!0),showProgress:et(s.show_progress,!0),collapseTo:e,itemTapAction:s.item_tap_action??"toggle"}}function fe(s,e){let t=s.find(i=>i.startsWith("todo.")&&typeof e[i]?.attributes.list_id=="string")??s.find(i=>i.startsWith("todo."))??"";return{type:`custom:${pi}`,entity:t}}var N={CREATE:1,DELETE:2,UPDATE:4,MOVE:8},ve="unavailable",be="unknown",O=(s,e)=>((s?.attributes.supported_features??0)&e)!==0,ye=(s,e,t)=>s.connection.subscribeMessage(t,{type:"todo/item/subscribe",entity_id:e}),xe=(s,e,t)=>s.callService("todo","add_item",{item:t},{entity_id:e}),Mt=(s,e,t,i)=>s.callService("todo","update_item",{item:t.uid,status:i},{entity_id:e}),$e=(s,e,t,i)=>s.callService("todo","update_item",{item:t.uid,rename:i,status:t.status??"needs_action"},{entity_id:e}),St=(s,e,t)=>s.callService("todo","remove_item",{item:t},{entity_id:e}),we=(s,e,t,i)=>s.callWS({type:"todo/item/move",entity_id:e,uid:t,previous_uid:i}),Ae=(s,e)=>s.callWS({type:"config/entity_registry/get",entity_id:e}),Ee=(s,e)=>s.callWS({type:"config_entries/get",domain:e}),Te=s=>s.callWS({type:"config_entries/flow/progress"}),Ce="/config/integrations/integration/listapp";function ke(s){history.pushState(null,"",s),window.dispatchEvent(new CustomEvent("location-changed",{bubbles:!0,composed:!0,detail:{replace:!1}}))}function mi(s){let e=[],t=[];for(let i of s)(i.status==="completed"?t:e).push(i);return{active:e,completed:t}}function It(s){return s?s.attributes.role==="viewer"?!0:!O(s,N.CREATE)||!O(s,N.UPDATE):!1}function gi(s,e,t){return t||e<=0||s.length<=e?{shown:s,hidden:0}:{shown:s.slice(0,e),hidden:s.length-e}}function _i(s,e,t){return t?`${s} ${s===1?"item":"items"} \xB7 view only`:s===0?"No items":`${e} of ${s} done`}function fi(s,e){let t=s?.attributes.friendly_name;return typeof t=="string"&&t.trim()?t:e.split(".")[1]?.replace(/^listapp_/,"").replace(/_/g," ")??e}var Rt=s=>s.state===ve||s.state===be;function Pt(s,e,t,i=void 0,n="listapp"){return!s||!Rt(s)?"available":t?.some(a=>a.handler===n&&a.context?.source==="reauth"&&(!i||a.context.entry_id===i))||e?.some(a=>a.domain===n&&(!i||a.entry_id===i)&&a.state==="setup_error"&&/auth|token|sign in|log in|credential/i.test(a.reason??""))?"auth":"transient"}function Me({config:s,stateObj:e,items:t,availability:i,expanded:n}){let r=It(e),o=!r&&O(e,N.CREATE),a=!r&&O(e,N.UPDATE),l=!r&&O(e,N.DELETE),u=!r&&O(e,N.MOVE),{active:_,completed:c}=mi(t??[]),g=_.length+c.length,m=c.length,{shown:f,hidden:A}=gi(_,s.collapseTo,n),w;return e?i==="auth"?w="unavailable_auth":i==="transient"?w="unavailable_transient":t===void 0?w="loading":g===0?w="empty":_.length===0?w="all_done":w="list":w="missing",{state:w,viewer:r,canCreate:o,canUpdate:a,canDelete:l,canMove:u,title:s.title??fi(e,s.entity),subline:_i(g,m,r),total:g,done:m,progress:g===0?0:m/g,active:_,completed:c,visibleActive:f,hiddenActive:A,showHeader:s.showHeader,showAdd:s.showAdd&&o,showCompleted:s.showCompleted,showProgress:s.showProgress&&s.showHeader}}function Se(s,e,t){let i=s.filter(o=>o.uid!==e),n=s.find(o=>o.uid===e);if(!n)return{order:s,previousUid:void 0};let r=Math.max(0,Math.min(t,i.length));return i.splice(r,0,n),{order:i,previousUid:r===0?void 0:i[r-1].uid}}var Ht="listapp-list-card-impl",Dt="listapp-list-card-editor",Ut="listapp-list-card-editor-impl";var x={use_list_color:!0,show_header:!0,show_add:!0,show_completed:!0,show_progress:!0,collapse_to:0,item_tap_action:"toggle"},Re=[{value:"toggle",label:"Toggle"},{value:"edit",label:"Edit"}];function vi(s){let e=Object.keys(s.states).filter(i=>i.startsWith("todo.")),t=e.filter(i=>typeof s.states[i]?.attributes.list_id=="string");return t.length?t:e}function Ie(s){return{entity:s.entity??"",title:s.title??"",use_list_color:s.use_list_color??x.use_list_color,show_header:s.show_header??x.show_header,show_add:s.show_add??x.show_add,show_completed:s.show_completed??x.show_completed,show_progress:s.show_progress??x.show_progress,collapse_to:s.collapse_to??x.collapse_to,item_tap_action:s.item_tap_action??x.item_tap_action}}function bi(s,e){let t={type:e,entity:s.entity},i=typeof s.title=="string"?s.title.trim():"";i&&(t.title=i),s.use_list_color!==x.use_list_color&&(t.use_list_color=s.use_list_color),s.show_header!==x.show_header&&(t.show_header=s.show_header),s.show_add!==x.show_add&&(t.show_add=s.show_add),s.show_completed!==x.show_completed&&(t.show_completed=s.show_completed),s.show_progress!==x.show_progress&&(t.show_progress=s.show_progress);let n=typeof s.collapse_to=="number"&&Number.isInteger(s.collapse_to)&&s.collapse_to>=0?s.collapse_to:x.collapse_to;return n!==x.collapse_to&&(t.collapse_to=n),s.item_tap_action!==x.item_tap_action&&(t.item_tap_action=s.item_tap_action),t}function yi(s,e){return[{name:"entity",required:!0,selector:{entity:{include_entities:s}}},{name:"title",selector:{text:{}}},{name:"use_list_color",selector:{boolean:{}}},{name:"show_header",selector:{boolean:{}}},{name:"show_add",selector:{boolean:{}}},{name:"show_completed",selector:{boolean:{}}},{name:"show_progress",selector:{boolean:{}},disabled:!e},{name:"collapse_to",selector:{number:{min:0,mode:"box"}}},{name:"item_tap_action",selector:{select:{mode:"dropdown",options:Re}}}]}var j={entity:"List",title:"Title override",use_list_color:"Use list colour",show_header:"Show header",show_add:"Show add field",show_completed:"Show completed",show_progress:"Show progress bar",collapse_to:"Collapse to (0 = off)",item_tap_action:"Tap action"},q=class extends E{constructor(){super(...arguments);this._haForm=null;this._haFormChanged=t=>{t.stopPropagation(),this._emit(t.detail.value)};this._nativeChanged=t=>i=>{let n=i.currentTarget,r=Ie(this._config);n instanceof HTMLInputElement&&n.type==="checkbox"?r[t]=n.checked:n instanceof HTMLInputElement&&n.type==="number"?r[t]=Math.max(0,Math.trunc(Number(n.value)||0)):r[t]=n.value,this._emit(r)}}setConfig(t){this._config=t}connectedCallback(){super.connectedCallback(),this._haForm=customElements.get("ha-form")?!0:null,this._haForm===null&&customElements.whenDefined("ha-form").then(()=>{this._haForm=!0})}_entityIds(){if(!this.hass)return[];let t=vi(this.hass),i=this._config?.entity;return i&&!t.includes(i)?[i,...t]:t}render(){if(!this.hass||!this._config)return h;let t=Ie(this._config);return p`
    ...
    `}_renderHaForm(t){return p`
      <ha-form
        .hass=${this.hass}
        .data=${t}
        .schema=${yi(this._entityIds(),t.show_header)}
    ...
    `}_emit(t){let i=bi(t,this._config.type);this._config=i,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:i},bubbles:!0,composed:!0}))}static{this.styles=K`
    :host {
      display: block;
    }
    .native {
