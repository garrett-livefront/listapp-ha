      ...
      <div class="native">
        ...
        <label class="field">
          ...
          <select .value=${t.item_tap_action} @change=${this._nativeChanged("item_tap_action")}>
            ${De.map(r=>p`<option value=${r.value} ?selected=${r.value===t.item_tap_action}>${r.label}</option>`)}
          </select>
        </label>
      </div>
